...
const ProductOne = (props) => {
  ...
  const { id, title, price } = useSelector((state) => state.product[0]);
...
const ProductTwo = (props) => {
  ...
  // You should see the price is updated
  const { id, title, price } = useSelector((state) => state.product[1]);
  const product = { id, title, price };
...
const CartProductOne = (props) => {
  ...
  const productOne = useSelector((state) => state.cart.products[0]);

  const product = { price: productOne.price, qty: productOne.qty };
...
const CartProductTwo = (props) => {
  ...
  // Change the price of products in `service/cart/slice.js` to see the effect
  const productTwo = useSelector((state) => state.cart.products[1]);
  const product = { price: productTwo.price, qty: productTwo.qty };
